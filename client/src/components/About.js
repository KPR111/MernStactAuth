...
import hero from "../images/vijay.jpg";
import nothero from "../images/nothero.jpg";
const About = () => {
        ...
        <form action="">
          <div className="row">
            <div className="col-md-4">
              <img src={userData.name==="kpr"?hero:nothero} className="pphoto" width={200} alt="profile photo" />
            </div>
